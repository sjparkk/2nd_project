...
<%
	...
	List<Board> boardList = boardService.findBoardListAll();
...
<script type="text/javascript">
	...
	function myBoardList() {
		location.href="board_myList.jsp";
	}
</script>
</head>
<body>
	...
	<main>
		...
		<%for(Board board : boardList) {  %>
		    <li class="list-group-item d-flex justify-content-between align-items-center">
		      <span class="boardNo"><%=board.getBoardNo() %></span>
		      <span class="title" ><a style="color:black;" href='board_view.jsp?boardNo=<%=board.getBoardNo() %>'><%=board.getBoardTitle() %></a></span>
		      <span class="customer"><%=board.getUserInfo().getUserId() %></span>
		...
		<!-- 본문 끝 -->
		  ...
		  <br/>
			 	...
			 	<br/>
					...
					&nbsp; <input type="button" class="btn  btn-sm" id ='myBoard' value='내가 쓴 글' onclick='myBoardList();'
							style=" width: 80px;height: 20px;font-size: 17px;padding:0px;">
			   </div>
