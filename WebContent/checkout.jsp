...
<%
	...
	List<Cart> cartList=cartService.findCartListByUserNo(user.getUserNo());
	if(cartList.size()==0){
		out.println("<script>");
		out.println("alert('상품을 담아 주세요.')");
	...
	total+=productService.findProductByNo(cart.getProductno()).getProductPrice()*cart.getProductqty();
	}
				...
				<div class="billing_details">
					<div class="row">
						<div class="col-lg-8">
							...
							<form class="row contact_form" action="checkout_action.jsp" method="post"
								novalidate="novalidate" name="submitForm" id="submitForm">
								...
								<h3>Payment card</h3>
									...
									<input type="text" id="total" class="userNo" name ="total" value="<%=total%>">	
						...
						<div class="col-lg-4">
							<div class="order_box">
								...
								<ul class="list">
									...
									<%for(Cart cart:cartList){ %>
									<li><a><%=productService.findProductByNo(cart.getProductno()).getProductName()%>
									 <span class="middle" ></span>
									<span class="last">x<%=cart.getProductqty() %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=productService.findProductByNo(cart.getProductno()).getProductPrice()*cart.getProductqty() %></span>
									</a></li>
									<%} %>
									
								</ul>
								<ul class="list list_2">
									<li><a>Total <span><%=total %></span>
									</a></li>
								</ul>
