		...
		<section class="sample-text-area">
			<div class="container box_1170">
				...
				<p class="sample-text">
					...
					creative prowess. Many have great ideas and want to âwowâ the<sup>Superscript</sup>
					scene, or video renters with their big project. But once you have
					the<sub>Subscript</sub> âin the canâ (no easy feat), how do you
					move from a
					<del>Strike</del>
					through of master DVDs with the <u>âUnderlineâ</u> marked
					...
					<div class="row">
						<div class="col-md-9">
							...
							<p class="text-right">Before we discuss all of the things
								that could be affecting your PCâs performance, letâs talk a
