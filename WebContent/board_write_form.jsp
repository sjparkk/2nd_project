		...
		<table border="0" cellpadding="0" cellspacing="1" width="590" bgcolor="BBBBBB">
			<tr>
				...
				<td bgcolor="white" width="450" style="padding-left: 10px"><select name ="type" size="1" >
					<option value="문의하실 유형을 선택하세요"><font size="2">문의하실 유형을 선택하세요</font></option>
			...
			<tr>
				...
				<td width=490 bgcolor="ffffff" style="padding-left: 10px" align="left">
					<input type="text" style="width: 450px" name="title"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td width=490 bgcolor="ffffff" style="padding-left: 10px" align="left">
					<textarea id="fileName" style="height:30px" name="fileName" readonly></textarea>
			...
			<table width=590 border=0 cellpadding=0 cellspacing=0>
				<tr>
					<td align=center><br/>
					<input type="button" value="등록" onClick="boardCreate()"> &nbsp; 
